...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/home/meghal/Personal/Konverge_AI/Training/Rest APIs with Flask and Python/Flask Practice/Flask-RESTful/venv'
    let bin = 'bin'
    let path-sep = ':'
...
alias deactivate = source '/home/meghal/Personal/Konverge_AI/Training/Rest APIs with Flask and Python/Flask Practice/Flask-RESTful/venv/bin/deactivate.nu'
